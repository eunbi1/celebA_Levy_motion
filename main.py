...
parser.add_argument('--alpha', type=float, default = 1.2, help='epochs')
...
parser.add_argument('--datasets', type=str, default = "CelebA")
parser.add_argument('--training_clamp', type=float, default =30)
